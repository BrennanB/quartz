...
- If object is rigid (examples: 2019 hatches, 2018 cubes, 2017 wiffle balls) you need compliance/compression either in the mechanism (pivoting point allow floating wheel/roller and springs/pneumatic-pressure generates squeeze force) or in the wheels/rollers (flex wheels, thick rubber surfaces).
...
- Build robust intakes
	...
	- Big plates with plenty of material around holes. Ideally small holes, thats why the dead axle roller design is so good, you only have a bolt hole in the plate
